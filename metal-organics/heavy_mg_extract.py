...
def remove_nitrate(st):
    patterns =('[OX1][NX3]([OX1])([OX1])','[OX1][CX3]([OX1])([OX1])', '[OX1][ClX4]([OX1])([OX1])([OX1])', '[OX1][IX3]([OX1])([OX1])','[OX1][BrX3]([OX1])([OX1])','[OX1][SX4]([OX1])([OX1])[OX1]','[OX1][PX4]([OX1])([OX1])[OX1]', '[ClX0]', '[FX0]', '[BrX0]', '[IX0]', '[FX1][P,AsX6,SbX6]([FX1])([FX1])([FX1])([FX1])([FX1])', '[FX1,HX1][CX4]([FX1,HX1])([FX1,HX1])[SX4]([OX1])([OX1])[OX1]','[ClX1][SnX6]([ClX1])([ClX1])([ClX1])([ClX1])([ClX1])', '[ClX1][GaX4]([ClX1])([ClX1])[ClX1][GaX4]([ClX1])([ClX1])[ClX1]') 
    charges = (1,2,1,1,1,2,3,1,1,1,1,1,1,2,1)
...
def has_heavy_mg(st):
    mg_list = ['Ge', 'As', 'Se', 'Sb', 'In', 'Te']
    return bool(evaluate_asl(st, f'at.ele {" or at.ele ".join(mg_list)}'))
...
def extract_molecules(cod_code, cod_path, output_path):
    ...
    if not has_heavy_mg(st) or len(evaluate_asl(st, "metals")) > 0:
        return cod_code
...
#        if not has_heavy_mg(mol_st) or len(evaluate_asl(mol_st, "metals")) > 0:
#            continue
#        try:
