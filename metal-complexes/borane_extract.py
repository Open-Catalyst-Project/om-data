...
def remove_nitrate(st):
    patterns =('[OX1][NX3]([OX1])([OX1])','[OX1][CX3]([OX1])([OX1])', '[OX1][ClX4]([OX1])([OX1])([OX1])', '[OX1][IX3]([OX1])([OX1])','[OX1][BrX3]([OX1])([OX1])','[OX1][SX4]([OX1])([OX1])[OX1]','[OX1][PX4]([OX1])([OX1])[OX1]', '[ClX0]', '[FX0]', '[BrX0]', '[IX0]', '[FX1][P,AsX6]([FX1])([FX1])([FX1])([FX1])([FX1])', '[FX1,HX1][CX4]([FX1,HX1])([FX1,HX1])[SX4]([OX1])([OX1])[OX1]','[ClX1][SnX6]([ClX1])([ClX1])([ClX1])([ClX1])([ClX1])', '[ClX1][GaX4]([ClX1])([ClX1])[ClX1][GaX4]([ClX1])([ClX1])[ClX1]') 
