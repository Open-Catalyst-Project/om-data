""" Adapted from Architector/development/lig_sampling/production_scripts/run_script.py """
...
def run_static(inp_dict, outpath):
    ...
    try:
        ...
        with open(
            os.path.join(outpath, inp_dict["name"] + "_failed.txt"), "w"
        ) as file1:
        ...
        resultsdf.to_pickle(os.path.join(outpath, inp_dict["name"] + ".pkl"))
        return inp_dict["name"], True


out = run_static(inp_dict, outpath)
