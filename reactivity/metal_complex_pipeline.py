...
#    os.makedirs(args.output_path)
    ...
    charge_spin_dict = loadfn(os.path.join(args.input_path, "charge_spin_dict.json"))
    ...
    for ii in tqdm(range(args.start_index, args.end_index)):
        ...
        charge = charge_spin_dict[name]['total_charge']
        uhf = charge_spin_dict[name]['total_uhf']
